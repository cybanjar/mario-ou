<template>
  <div class="column" style="margin: 20px">
    ...
    <div class="col">
      <SearchRoomTableSetup :searches="searches" />
    </div>
    <div class="col">
      <STable
        :loading="isFetching"
                ...
                >
                  <q-list :props="props">
                    ...
                    <q-item clickable v-ripple>
                      <q-item-section>Preview Image</q-item-section>
                    </q-item>
                    <q-item
                      <q-item
...
import { tableHeaders } from './tables/RoomTableSetup.table';
...
export default defineComponent({
  ...
  components: {
    SearchRoomTableSetup: () => import('./components/SearchRoomTableSetup.vue'),
  },
});
</script>
