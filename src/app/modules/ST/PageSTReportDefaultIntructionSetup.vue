<template>
  <div class="column" style="margin: 20px">
    ...
    <div class="col">
      <ActionDefaultIntructionSetup @onClickDialogIntruction="onClickDialogIntruction" :colors="colors" />
    </div>
    <div class="col">
      <STable
        flat
    ...
    <dialogIntruction @onDialogIntruction="onDialogIntruction" />
...
import { tableHeaders } from './tables/DefaultIntructionSetup.table';
...
export default defineComponent({
  setup(_, { root: { $api } }) {
    ...
    return {
      ...
      onAdd,
      onClickEdit,
      onClickDialogIntruction
    };
  },
  components: {
    ActionDefaultIntructionSetup: () =>
      import('./components/ActionDefaultIntructionSetup.vue'),
    CheckPermission: () => import('./components/DialogCheckPermission.vue'),
    dialogIntruction: () => import('./components/DialogIntruction.vue'),
  },
});
</script>
