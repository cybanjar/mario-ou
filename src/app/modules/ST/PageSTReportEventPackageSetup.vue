  ...
  <div class="column" style="margin: 20px">
    <div class="col">
      <div class="q-mb-md">
        ...
        <q-btn @click="showDialog()" flat round class="q-mr-md">
          <img :src="require('~/app/icons/Icon-Pay.svg')" height="25">
            <q-tooltip>
              Pakage Lines
            </q-tooltip>
          </img>
    ...
    <div class="col">
      <ActionEventPackageSetup :colors="colors" />
    </div>
    <div class="col">
      <STable
        flat
    ...
    <dialogPackageLines :show="show"  @onDialog="onDialog" />    
...
import { tableHeaders } from './tables/EventPackageSetup.table';
...
export default defineComponent({
  ...
  setup(props, { emit, root: { $api } }) {
    ...
    const onDialog = (val) => {
      state.show = val;
      console.log("Masuk onDialog : ");
    };

    const showDialog = () => {
      console.log("Masuk showDialog : ");
      onDialog(true);
    };
  ...
  components: {
    ...
    dialogPackageLines: () => import('./DialogPackageLines.vue'),
  },
});
</script>
