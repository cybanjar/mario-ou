<template>
  <div class="column" style="margin: 20px">
    ...
    <ActionMarketSegmenGroupSetup :colors="colors" />
...
import { tableHeaders } from './tables/MarketSegmentCodeSetup.table';
...
export default defineComponent({
  ...
  components: {
    ActionMarketSegmenGroupSetup: () =>
      import('./components/ActionMarketSegmenGroupSetup.vue'),
