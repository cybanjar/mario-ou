    ...
    <div>
        <div class="column justify-between">
            <div class="col-7" style="height: 570px">
                ...
                bordered :width="360" 
                persistent>
                <SearchStoredwithDML :searches="searches" @ADD="ADD"/>
                </q-drawer>
                <div class="q-pa-lg">
                  <div class="q-mb-md">
...
import {use_input, tableHeaders} from './tables/StoredwithDML'
...
export default defineComponent({
    ...
    components: {
        SearchStoredwithDML: () => import('./components/SearchStoredwithDML.vue')
    },
})
</script>
