    ...
    <div>
        <div class="column justify-between">
            <div class="col-7" style="height: 570px">
                ...
                bordered :width="360" 
                persistent>
                <SearchIssuedwithDML :searches="searches" @ADD="ADD"/>
                </q-drawer>
                <div class="q-pa-lg">
                  <div class="q-mb-md">
...
import {use_input, tableHeaders} from './tables/IssuedwithDML'
...
export default defineComponent({
    ...
    components: {
        SearchIssuedwithDML: () => import('./components/SearchIssuedwithDML.vue')
    },
})
</script>
