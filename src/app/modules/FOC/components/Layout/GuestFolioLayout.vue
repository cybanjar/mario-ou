...
export default defineComponent({
  ...
  components: {
    GuestFolioMenu: () =>
      import('~/app/modules/FOC/components/Shared/GuestFolioMenu.vue'),
    DialogGuestFolio: () =>
      import(
    ...
    DiaolgCancelReason: () =>
      import('~/app/modules/FOC/components/Dialog/DiaolgCancelReason.vue'),
    DiaolgSplitItem: () =>
      import('~/app/modules/FOC/components/Dialog/DiaolgSplitItem.vue'),
  },
});
</script>
