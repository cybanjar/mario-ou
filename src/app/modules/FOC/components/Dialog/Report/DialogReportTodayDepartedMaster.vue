...
import { ResTableHeaders } from '../../../tables/Report/reportTodayDepartedGuestBill.table';
import { ResTableLists } from '../../../models/Report/reportTodayDepartedGuestMaster.model';
