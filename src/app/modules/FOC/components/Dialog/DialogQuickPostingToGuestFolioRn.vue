<template>
  <q-dialog v-model="getDialogQptgfRn">
...
export default defineComponent({
  setup(props, { root: { $api } }) {
    ...
    const getDialogQptgfRn = computed(() => {
      return store.getters.focGuestFolio.GET_DIALOG_QPTGF_RN;
    });
    ...
    const onClickCancel = async () => {
      store.commit.focGuestFolio.SET_DIALOG_QPTGF_RN(false);
    };
